...
즉, 현재 Matchuri는 Swagger UI 중심으로 운영하며 Spring REST Docs 스니펫은 생성하지 않습니다.
...
- 문서 생성 파이프라인을 둘로 유지하는 대신 Swagger 산출물을 정확하게 유지하는 편이 운영 효율이 높습니다.
