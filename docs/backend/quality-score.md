...
| 영역 | 상태 | 확인 |
| --- | --- | --- |
| Backend tests | 가능 | `app/backend`에서 `./gradlew test --quiet` |
| Backend CI | 있음 | `app/backend/.github/workflows/backend-ci.yml` |
| Frontend lint | 가능 | `app/frontend`에서 `npm run lint` |
