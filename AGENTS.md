...
- 프로젝트 소개, 포트폴리오 서사, 협업 방식처럼 사람이 읽을 맥락은 `matchuri.wiki/`에 남깁니다.
- `matchuri.wiki/`는 GitHub Wiki와 연결된 독립 문서 저장소로 취급합니다. 위키 문서 안에는 `../docs/...` 같은 루트 프로젝트 상대 링크나 개발 기준 문서 참조 링크를 남기지 않습니다.
